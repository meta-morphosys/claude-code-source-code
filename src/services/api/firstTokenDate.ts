...
/**
 * Fetch the user's first Obsidian Code token date and store in config.
 * This is called after successful login to cache when they started using Obsidian Code.
 */
