...
const DEFAULT_PREFIX = `You are Obsidian Code, a CLI-based agentic coding tool powered by Claude.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Obsidian Code, a CLI-based agentic coding tool powered by Claude, running within the Claude Agent SDK.`
