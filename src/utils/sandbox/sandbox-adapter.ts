...
/**
 * Resolve Obsidian Code-specific path patterns for sandbox-runtime.
 *
 * Obsidian Code uses special path prefixes in permission rules:
...
/**
 * Convert Obsidian Code settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Obsidian Code started)
