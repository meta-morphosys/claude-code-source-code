...
// Always ask when Obsidian Code tries to edit its own config files
 ...
 * This is a per-user temporary directory used by Obsidian Code for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by Obsidian Code)
