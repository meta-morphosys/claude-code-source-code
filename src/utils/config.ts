...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when Obsidian Code was first started on this machine
  ...
  // Obsidian Code usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Obsidian Code OAuth token
  ...
  // Obsidian Code hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
